...
public class Functions extends AppCompatActivity {
    ...
    public void bar3MatrixFunction(){
        ...
        EditText zMatrix[][] = new android.widget.EditText[3][3];
        zMatrix[0][0] = z11;
        zMatrix[0][1] = z12;
        zMatrix[0][2] = z13;
        zMatrix[1][0] = z12;//z21
    ...
    public void bar4MatrixFunction(){
        ...
        EditText zMatrix[][] = new android.widget.EditText[4][4];
        zMatrix[0][0] = z11;
        zMatrix[0][1] = z12;
        zMatrix[0][2] = z13;
        zMatrix[0][3] = z14;
    ...
    public void bar5MatrixFunction(){
        ...
        EditText zMatrix[][] = new android.widget.EditText[5][5];
        zMatrix[0][0] = z11;
        zMatrix[0][1] = z12;
        zMatrix[0][2] = z13;
        zMatrix[0][3] = z14;
    ...
    public EditText[][] bar6MatrixFunction(){
        //input voltage vlaue
        ...
        EditText zMatrix[][] = new android.widget.EditText[6][6];
        zMatrix[0][0] = z11;
        zMatrix[0][1] = z12;
        zMatrix[0][2] = z13;
        zMatrix[0][3] = z14;
    ...
    public void bar7MatrixFunction(){
        ...
        EditText zMatrix[][] = new android.widget.EditText[7][7];
        zMatrix[0][0] = z11;
        zMatrix[0][1] = z12;
        zMatrix[0][2] = z13;
        zMatrix[0][3] = z14;
