...
public class Main2Activity extends AppCompatActivity {
    ...
    private void moveNext(){
        ...
        Intent intent1 = new Intent(Main2Activity.this, Part3of3buses.class);

        intent1.putExtra("Voltage 1:", voltages1);
        intent1.putExtra("Voltage 3:", voltages2);
        intent1.putExtra("Voltage 4:", voltages3);
        intent1.putExtra("Iterations:", iterations);
